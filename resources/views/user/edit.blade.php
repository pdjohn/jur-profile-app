    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{__('Update User Information')}}</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <form role="form" id="editForm" action="{{route('user.update', $data->id)}}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="company_name" name="company_name"
                                                   value="{{ old('company_name', $data->experience[0]->company_name) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="role" name="role"
                                                   value="{{ old('role', $data->experience[0]->role) }}" required>
                                            @if ($errors->has('role'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="date" class="form-control take_past_date" id="job_start_date" name="job_start_date"
                                                   value="{{ old('job_start_date', $data->experience[0]->job_start_date) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <input type="date" class="form-control take_past_date" id="job_end_date" name="job_end_date"
                                                   value="{{ old('job_end_date', $data->experience[0]->job_end_date) }}" >
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="current_job" value="1" {{ $data->experience[0]->job_end_date == NULL ? 'checked':'' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="company_description" name="company_description"
                                                      required>{{ old('company_description', $data->experience[0]->company_description) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="organization_name" name="organization_name"
                                                   value="{{ old('organization_name', $data->experience[0]->organization_name) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="associated_as" name="associated_as"
                                                   value="{{ old('associated_as', $data->experience[0]->associated_as) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="date" class="form-control take_past_date" id="organization_start_date" name="organization_start_date"
                                                   value="{{ old('organization_start_date', $data->experience[0]->organization_start_date) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <input type="date" class="form-control take_past_date" id="organization_end_date" name="organization_end_date"
                                                   value="{{ old('organization_end_date', $data->experience[0]->organization_end_date) }}" >
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="current_organization" value="1" {{ $data->experience[0]->organization_end_date == NULL ? 'checked':'' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="organization_description" name="organization_description"
                                                      required>{{ old('organization_description', $data->experience[0]->company_description) }}</textarea>
